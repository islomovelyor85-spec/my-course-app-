  ...
  return (
    <div>
      ...
      <div className="border border-beige rounded-xl2 overflow-hidden bg-paper">
        <div className="hidden sm:grid grid-cols-[1fr_0.8fr_1fr_1fr_auto] gap-3 px-4 py-3 bg-beige-soft text-[11px] font-medium text-ink-soft/50 uppercase tracking-wide">
          <span>O‘quvchi</span>
          <span>Kurs</span>
        ...
        <div className="divide-y divide-beige">
          {filtered.map((s) => (
            <div key={s.id} className="grid grid-cols-1 sm:grid-cols-[1fr_0.8fr_1fr_1fr_auto] gap-2 sm:gap-3 px-4 py-3.5 items-center">
